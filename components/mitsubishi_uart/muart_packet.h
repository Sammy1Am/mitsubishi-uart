...
enum PacketType : uint8_t {
  ...
  extended_connect_response = 0x5a
};
...
class Packet {
  ...
  public:
    // Constructors
    Packet(uint8_t packet_header[PACKET_HEADER_SIZE], uint8_t payload[], uint8_t payload_size, uint8_t checksum); // For reading packets
